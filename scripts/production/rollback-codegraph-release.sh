...
readonly base_compose="${FRANK_BASE_COMPOSE:-/frank/deployed/infra/docker-compose.dev.yml}"
readonly caddyfile="${FRANK_CADDYFILE:-/frank/deployed/infra/Caddyfile}"
...
[[ -n "$snapshot_input" ]] || die "usage: rollback-codegraph-release.sh /frank/deployed/backups/codegraph/<timestamp>"
...
[[ "$caddyfile" == '/frank/deployed/infra/Caddyfile' ]] || die "refusing unexpected live Caddyfile"
