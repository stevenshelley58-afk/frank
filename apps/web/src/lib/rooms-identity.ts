...
// Central gets the full-org ops-lead identity; project rooms get a scoped
// orchestrator that reads everywhere but writes only inside its project.
...
export const ROOM_IDENTITIES: Record<string, string> = {
  ...
  chase: [
    ...
    'Acknowledge what you captured and the next concrete step.',
  ].join('\n'),
};
