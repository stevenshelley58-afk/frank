...
class HomePlatformApiTest(unittest.TestCase):
    ...
    def test_connections_store_metadata_only_and_activepieces_contract(self):
        ...
        self.assertEqual(self.client.put("/api/homes/project/blockwise", json={"expected_revision": 0, "instances": instances}).status_code, 200)
    ...
    def test_connections_reject_provider_keys_tokens_and_payment_data_everywhere(self):
        jwt = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmcmFuay10ZXN0LXVzZXIifQ.signature_value_123456"
        attempts = [
