...
class UiContractTest(unittest.TestCase):
    ...
    def test_ad_studio_is_a_real_tool_surface_backed_by_hermes(self):
        ...
        self.assertIn('mergeAdStudioRunList(runs, data.runs)', studio)
        ...
        self.assertIn('new URLSearchParams({ limit: "100" })', studio)
        ...
        self.assertIn('/app.css?v=20260904-brief-roundtrip-v1', html)
        self.assertIn('/js/app.js?v=20260904-brief-roundtrip-v1', html)
        self.assertIn('./ad-studio.js?v=20260904-brief-roundtrip-v1', app)
