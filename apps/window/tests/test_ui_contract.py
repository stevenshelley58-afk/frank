...
class UiContractTest(unittest.TestCase):
    ...
    def test_ad_template_generator_is_a_real_tool_surface_backed_by_hermes(self):
        ...
        self.assertIn('/app.css?v=20260908-review-chat-v1', html)
        self.assertIn('/js/app.js?v=20260908-review-chat-v1', html)
        self.assertIn('./ad-template-generator.js?v=20260908-review-chat-v1', app)
