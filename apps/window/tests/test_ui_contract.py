...
class UiContractTest(unittest.TestCase):
    ...
    def test_entity_homes_keep_the_canonical_operational_rail(self):
        ...
        self.assertEqual(
            rail_views,
            ["hub", "tools", "files", "ad-template-generator", "ad-db", "blog-studio", "trace", "releases", "live", "map", "control", "ops"],
        )
