...
class UiContractTest(unittest.TestCase):
    ...
    def test_ad_studio_is_a_real_tool_surface_backed_by_hermes(self):
        ...
        self.assertIn('One comparator applies focused corrections until both placements reach 9.8 likeness.', html)
        self.assertIn('Two final reviews and the Blockwise smoke test must pass', html)
