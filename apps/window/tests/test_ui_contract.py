...
class UiContractTest(unittest.TestCase):
    ...
    def test_ad_studio_is_a_real_tool_surface_backed_by_hermes(self):
        ...
        self.assertIn('mergeAdStudioRun(existing.get(run.id), run)', studio)
        ...
        self.assertIn('const selectionCleared = Boolean(selectedRunId && !runs.some((run) => run.id === selectedRunId))', studio)
