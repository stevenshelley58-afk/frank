...
only PNG/JPEG/WebP files in old iterations, comparison previews and reusable-test
renders. Keep the best iteration and its previews, every final/review package,
all JSON history and scores, demo assets and references. Historical draft-image
