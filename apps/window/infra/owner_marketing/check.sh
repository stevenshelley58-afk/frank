...
docker exec frank-owner-marketing php -r 'require "/var/www/html/vendor/autoload.php"; $c=implode(chr(92), ["Symfony", "Component", "DomCrawler", "Crawler"]); exit((new $c("<a href=target>Link</a>"))->filter("a")->count() === 1 ? 0 : 1);' || die native-html-validator-dependency-missing
