...
class ActivationTests(unittest.TestCase):
    def setUp(self):
        self.state={"accounts":[{"name":"Blockwise Owner Inbox","email_id":"hello@blockwise.sale","enable_incoming":1,"enable_outgoing":1}],"pending_queue":0,"enabled_email_notifications":0,"enabled_email_reports":0}
