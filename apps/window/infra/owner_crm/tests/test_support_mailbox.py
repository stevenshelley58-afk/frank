...
class SupportMailboxTests(unittest.TestCase):
    ...
    def test_missing_preview_does_not_create(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "support_folder_missing"): module.ensure_folder(client)
    ...
    def test_false_creation_fails_closed(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "support_folder_readback_failed"): module.ensure_folder(client, True)
