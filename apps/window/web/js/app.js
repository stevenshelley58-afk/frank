...
import "./widgets.js?v=20260915-approved-system-v3";
...
import { mountBlogStudio } from "./blog-studio.js?v=20260915-approved-system-v3";
...
function openPathView() {
  ...
  if (route.view === "project") {
    ...
    window.history.replaceState({ view: "hub" }, "", `${pathForView("hub")}${window.location.search}`);
...
fetchProjects().then(openPathView).catch(openPathView);
