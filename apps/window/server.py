...
def ad_radar_run_create():
    ...
    if not AD_TEMPLATE_GENERATOR_RUN_ID.fullmatch(run_id) or not _is_scoped_ad_radar_run(run, project_id):
        return jsonify({
...
app.register_blueprint(owner_customers.create_blueprint())
